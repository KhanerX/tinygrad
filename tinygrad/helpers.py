...
def time_to_str(_seconds: float, w=0) -> str: return next((f"{_seconds * d:{w}.2f} {pr}" for d, pr in [(1, "s"), (1e3, "ms"), (1e6, "us")] if _seconds > 1/d), f"{_seconds * 1e6:{w}.2f} us") # noqa: E501
