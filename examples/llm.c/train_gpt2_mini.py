...
class GPT:
  ...
  def load_pretrained(self):
    weights = nn.state.torch_load(fetch(f'https://huggingface.co/gpt2-large/resolve/main/pytorch_model.bin'))
  ...
  def __call__(self, idx:Tensor, targets=None):
    b, t = idx.shape
    pos = Tensor.arange(0, t).reshape(1, t).expand(b, t).shard_(("CLANG", "CUDA"), axis=0)
